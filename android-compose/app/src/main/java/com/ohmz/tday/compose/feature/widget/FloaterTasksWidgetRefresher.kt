...
/**
 * Re-renders the Floater widget from the offline cache. Unconditional on purpose — see
 * [TodayTasksWidgetRefresher] for why a content-signature guard was removed (stuck-stale risk).
 */
@Singleton
