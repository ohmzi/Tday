...
const railButtonClass =
  "group flex h-10 min-h-10 w-10 shrink-0 items-center justify-center rounded-sm text-sidebar-foreground/70 transition-colors duration-enter hover:bg-sidebar-accent/70 hover:text-sidebar-foreground";

const expandedButtonClass =
  "group flex h-12 min-h-12 w-full min-w-0 shrink-0 items-center gap-3 overflow-hidden rounded-lg px-2 text-base font-black text-muted-foreground transition-colors duration-enter hover:bg-card/70 hover:text-foreground";
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)}>
      ...
      {collapsed ? (
        ...
        <div className="flex h-12 min-h-12 w-full min-w-0 shrink-0 items-center gap-3 overflow-hidden rounded-lg px-2 text-base font-black text-foreground">
          <span className={expandedIconChip}>
