      ...
      <Card className="border-0 bg-card/80 shadow-xl backdrop-blur-sm">
        <CardHeader className="space-y-4 pb-2 text-center">
          <div className="mx-auto flex items-center justify-center">
            <img src="/tday-icon.svg" alt="T'Day" width={64} height={64} />
          </div>
          <div className="space-y-1">
            <CardTitle className="text-3xl font-serif">Create Account</CardTitle>
            <CardDescription className="text-muted-foreground">
              {"Start planning your day with T'Day"}
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent className="pt-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="h-12 w-full font-medium text-primary-foreground" disabled={isSubmitting}>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/login" className="font-medium text-accent transition-colors hover:text-accent/80">Sign in</Link>
            </p>
          </div>
        </CardContent>
      </Card>
      <PendingApprovalDialog open={pendingApprovalOpen} onOpenChange={setPendingApprovalOpen} />
    </>
  );
}
