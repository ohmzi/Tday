...
// NativeHomeDashboard's tiles. It only ever shows blurred behind an auth card, so the
// data is faked. Shared by the pending-approval and reset-password screens.
const MOCK_TILES = [
